                ...
                <View style={tw`  gap-6 w-full`}>
                    ...
                    <View style={tw`gap-2 w-full items-center`}>
                        ...
                        <Text style={tw`text-gray text-text10 font-sfpro-400 text-center`}>
                            Changing the option will show a popup confirmation and your next billing date
                        </Text>
                    </View>
                    ...
                    <View style={tw`gap-4 w-full flex-col items-center p-4 rounded-xl border-gray/30 border justify-between `}>
                        ...
                        <View style={tw`gap-2 w-full flex-row  justify-between `}>
                            <Text style={tw`text-gray text-text12 font-sfpro-600 `}>Current Plan</Text>
                            <Text style={tw`text-headingText text-text12 font-sfpro-600 `}>Monthly</Text>
                        </View>
                        <View style={tw`border-gray/30  w-full border-[.5px]`} />
                        <View style={tw`gap-2 w-full flex-row  justify-between `}>
                            <Text style={tw`text-gray text-text12 font-sfpro-600 `}>Changing to</Text>
                            <Text style={tw`text-primaryColor text-text12 font-sfpro-600 `}>Yearly</Text>
                        </View>
                        <View style={tw`border-gray/30  w-full border-[.5px]`} />
                        <View style={tw`gap-2 w-full flex-row  justify-between `}>
                            <Text style={tw`text-gray text-text12 font-sfpro-600 `}>Next billing date </Text>
                            <Text style={tw`text-headingText text-text12 font-sfpro-600 `}>July 30, 2026</Text>
                        </View>
                    </View>
                    ...
                    <View style={tw`flex-col items-center gap-5`}>
                        <TouchableOpacity onPress={() => {
                            router.back();
                        }} style={tw`bg-primaryColor w-full p-4 rounded-xl`}>
                        ...
                        <TouchableOpacity onPress={() => {
                            router.back();
                        }} style={tw`border border-primaryColor w-full p-4 rounded-xl`}>
