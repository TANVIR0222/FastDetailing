        ...
        <PageWrapper>
            ...
            <KeyboardAvoidingWrapper>
                <View style={tw`flex-1  flex-col gap-5 pt-1 `}>
                    <ProgressBar height={10} progress={60} />
                        ...
                        >
                            ...
                            (
                                <View style={tw` flex-1 flex-col gap-4 justify-between`}>
                                    <View >
                                        ...
                                        <View style={tw`relative `}>
                                            <View style={tw`flex-col gap-2.5`} >
                                                ...
                                                <TouchableOpacity
                                                    style={tw`flex-row items-center justify-between px-3 h-12 rounded-xl border border-[#999a9a4d] bg-white`}
                                    ...
                                    <View>
                                        <MainButton title="Add Now" onPress={() => handleSubmit()} />
                                    </View>
                                </View>
                            )
                            }
