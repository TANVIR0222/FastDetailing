                ...
                >
                    ...
                    <View style={tw` flex-col gap-4 `}>
                        ...
                        <View style={tw` flex-col gap-1 `}>
                            <MainButton title='Send Invoice' bm={true} />

                            <View style={tw` flex-col gap-3 `}>
                                <TouchableOpacity onPress={() => router.push('/charge-customer')} style={tw` border border-primaryColor py-3 rounded-lg  flex-row gap-2 justify-center items-center`}>
                                    <Text style={tw`text-text12 font-sfpro-500 text-primaryColor `}>Enter Card information</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={tw` bg-[#22C55E1A] py-3 rounded-lg  flex-row gap-2 justify-center items-center`}>
                                    <SvgXml xml={IconsCash} />
                                    <Text style={tw`text-text12 font-sfpro-500 text-bgGreen`}>Accept Cash</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </View>
