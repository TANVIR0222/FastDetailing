import { IconClick, IconDelivery, IconOpen, IconSendE } from '@/assets/Icons';
...
const cards = [
    {
        ...
        stats: [
            ...
            { icon: IconOpen, value: "14%", label: "Open Rate" },
            { icon: IconClick, value: "08%", label: "Click Rate" },
        ],
    },
    {
        title: "New Customer Welcome",
        ...
        stats: [
            ...
            { icon: IconOpen, value: "20%", label: "Open Rate" },
            { icon: IconClick, value: "10%", label: "Click Rate" },
        ],
    },
    {
        title: "New Customer Welcome",
        ...
        stats: [
            ...
            { icon: IconOpen, value: "5%", label: "Open Rate" },
            { icon: IconClick, value: "2%", label: "Click Rate" },
        ],
    },
];
...
export default function Index() {
    return (
        <PageWrapper>
            <GlobalTopBar title='Email Blast' addIiocns={true} route={() => router.push('/sms-campaigns')} />
