...
const ScheduleScreen: React.FC = () => {
    ...
    const renderItem: ListRenderItem<DaySchedule> = ({ item, index }) => (
        <View style={tw`flex-row items-center justify-between mb-3`}>
            {/* Day Switch */}
            <View style={tw`flex-row items-center justify-center  bg-white border border-border rounded-xl px-3 py-3 w-[28%]`}>
                <Switch
                    value={item.enabled}
            ...
            {/* Start Time */}
            <TouchableOpacity
                style={tw`flex-row items-center justify-center gap-1 bg-white border border-border rounded-xl px-3 py-3 w-[28%] `}
    ...
    return (
        <PageWrapper>
            <GlobalTopBar title="Availability" icon={true} />
