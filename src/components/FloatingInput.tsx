...
import { IconsClose, IconsCloseEyse, IconsEyse } from "@/assets/Icons";
...
const FloatingInput: React.FC<FloatingInputProps> = ({
    ...
    useEffect(() => {
        Animated.timing(labelAnim, {
            toValue: isFocused || value ? 0.8 : 0.1,
            duration: 200,
    ...
    return (
        <View style={tw`mb-3`}>
            ...
            >
                ...
                <TextInput
                    style={tw`flex-1 h-10 text-text12 font-sfpro-400 text-headingText mt-3`}
